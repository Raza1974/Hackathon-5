      ...
      <div className="py-12 sm:px-6">
        ...
        <div className="relative w-full h-screen bg-white flex items-center">
          ...
          <div className="w-55px ml-28 sm:block">
            <img src="/background.jpg" alt="About Us" />
          </div>
        </div>
        ...
        <div className="bg-white py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-[1440px] mx-auto space-y-12">
              ...
              <h1 className="text-2xl font-bold text-gray-900">
                Met minim Mollie non desert <br></br>Alamo est sit cliquey dolor do <br></br> met sent.</h1>
              <p className="text-gray-600">
            ...
            <div className="relative w-1440px h-764px ">
              <img
                src="/desktop-video-3.jpg"
                alt="Video Thumbnail"
                className="w-[1140] h-[764] px-0 py-1231"
              />
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row items-center w-[1440px] h-[637px] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex-1">
              <img
                ...
                alt="Company"
                className="w-[590px] h-[640px] px-850 py-0  object-cover"
              />
            </div>
          </div>
        </div>
